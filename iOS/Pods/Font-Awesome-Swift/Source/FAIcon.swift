...
public extension UITextField {
    ...
    public func setRightViewFAIcon(_ icon: FAType, rightViewMode: UITextField.ViewMode = .always, orientation: UIImage.Orientation = UIImage.Orientation.down, textColor: UIColor = .black, backgroundColor: UIColor = .clear, size: CGSize? = nil) {
    ...
    public func setLeftViewFAIcon(_ icon: FAType, leftViewMode: UITextField.ViewMode = .always, orientation: UIImage.Orientation = UIImage.Orientation.down, textColor: UIColor = .black, backgroundColor: UIColor = .clear, size: CGSize? = nil) {
        FontLoader.loadFontIfNeeded()
...
public extension UIButton {
    ...
    func setFAText(_ prefixText: String, icon: FAType?, postfixText: String, size: CGFloat?, forState state: UIControl.State, iconSize: CGFloat? = nil) {
...
public extension UIImageView {
     ...
     */
    public func setFAIconWithName(_ icon: FAType, textColor: UIColor, orientation: UIImage.Orientation = UIImage.Orientation.down, backgroundColor: UIColor = UIColor.clear, size: CGSize? = nil) {
        FontLoader.loadFontIfNeeded()
...
public extension UITabBarItem {
    ...
    public func setFAIcon(_ icon: FAType, size: CGSize? = nil, orientation: UIImage.Orientation = UIImage.Orientation.down, textColor: UIColor = UIColor.black, backgroundColor: UIColor = UIColor.clear, selectedTextColor: UIColor = UIColor.black, selectedBackgroundColor: UIColor = UIColor.clear) {
        FontLoader.loadFontIfNeeded()
...
public extension UIStepper {
    ...
    public func setFABackgroundImage(_ icon: FAType, forState state: UIControl.State) {
        FontLoader.loadFontIfNeeded()
    ...
    public func setFAIncrementImage(_ icon: FAType, forState state: UIControl.State) {
        FontLoader.loadFontIfNeeded()
    ...
    public func setFADecrementImage(_ icon: FAType, forState state: UIControl.State) {
        FontLoader.loadFontIfNeeded()
...
public extension UISlider {
    ...
    func setFAMaximumValueImage(_ icon: FAType, orientation: UIImage.Orientation = UIImage.Orientation.down, customSize: CGSize? = nil) {
        maximumValueImage = UIImage(icon: icon, size: customSize ?? CGSize(width: 25,height: 25), orientation: orientation)
    }
    
    func setFAMinimumValueImage(_ icon: FAType, orientation: UIImage.Orientation = UIImage.Orientation.down, customSize: CGSize? = nil) {
