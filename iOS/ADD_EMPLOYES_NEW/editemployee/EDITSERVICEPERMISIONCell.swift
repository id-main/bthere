//
//  EDITSERVICEPERMISIONCell.swift
//  bthree-ios
//
...
class EDITSERVICEPERMISIONCell: UITableViewCell{
    ...
    delegate.selectedDomainTwo(_WHICHDOMAIN: self.tag, _state: btnAddservicePermission.isSelected)
    }
    @IBOutlet weak var lblText: UILabel!
    @IBOutlet weak var arrow: UIImageView!
    var ISEXPANDED:Bool = false
    var delegate:saveInGlobalDelegate3!=nil
