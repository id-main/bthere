//
//  EDIT_EMPLOYE_FIRST_SCREEN.swift
//  Bthere
//
...
class EDIT_EMPLOYE_FIRST_SCREEN: UIViewController, UIGestureRecognizerDelegate, UITextFieldDelegate, UITableViewDelegate, UITableViewDataSource, saveInGlobalDelegate3 {
   ...
   //     OPENTABLE2_BUTTON.alpha = 0.7
    ...
    @IBAction func NEXTSTEP() {
        if self.isvalidname == true && self.isvalidphone == true {
            ...
            let viewEmployeeSettingsSetupWorkingHours: EDITEmployeeSettingsSetupWorkingHours = mainstoryb.instantiateViewController(withIdentifier: "EDITEmployeeSettingsSetupWorkingHours")as! EDITEmployeeSettingsSetupWorkingHours
    ...
    override func viewDidLoad() {
        ...
        TXTFULLNAME.backgroundColor = UIColor.lightGray
        TXTPHONENUMBER.backgroundColor = UIColor.lightGray
        TXTFULLNAME.alpha = 0.7
      ...
      //      OPENTABLE2_BUTTON.isUserInteractionEnabled = false
        ...
        ADD_EMPLOYEE.text = "EDIT_EMPLOYEE".localized(LanguageMain.sharedInstance.USERLANGUAGE)
