//
//  POP_UP_EXIT_THE_ADDING_AN_EMPLOYEE_SCREEN.swift
//  Bthere
//
...
class POP_UP_EXIT_THE_ADDING_AN_EMPLOYEE_SCREEN: UIViewController, UIGestureRecognizerDelegate {
    ...
    override func viewDidLoad() {
        ...
        txtView.text = "ARE_YOU_SURE_YOU_WANT_TO_EXIT_THE_ADDING_AN_EMPLOYEE_SCREEN".localized(LanguageMain.sharedInstance.USERLANGUAGE)
