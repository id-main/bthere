//
//  POP_UP_BEFORE_ADD_YOUR_EMPLOYEES.swift
//  Bthere
//
//  Created by Ioan Ungureanu on 15/03/2019
...
class POP_UP_BEFORE_ADD_YOUR_EMPLOYEES: UIViewController, UIGestureRecognizerDelegate {
    ...
    override func viewDidLoad() {
        ...
        titletext.text = "YOU_HAVE_EMPLOYEES_IN_YOUR_BUSINESS".localized(LanguageMain.sharedInstance.USERLANGUAGE)  //title
        titletext.textAlignment = .center
        WHAT_DO_YOU_GET_WHEN_ADDING_AN_EMPLOYEE.text = "WHAT_DO_YOU_GET_WHEN_ADDING_AN_EMPLOYEE".localized(LanguageMain.sharedInstance.USERLANGUAGE) //second line
        txtView.text = "EXPLAIN_ADD_EPMPLOYE_PRICE".localized(LanguageMain.sharedInstance.USERLANGUAGE) //long text explain manager and employee benefits
        ...
        btncontinue.setTitle("CONTINUE_TO_ADDING_EMPLOYEES".localized(LanguageMain.sharedInstance.USERLANGUAGE), for: .normal)
    }
