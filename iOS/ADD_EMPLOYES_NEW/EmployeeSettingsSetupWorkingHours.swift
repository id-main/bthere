//
//  EmployeeSettingsSetupWorkingHours.swift
//  Bthere
//
//  Created by Ioan Ungureanu on 13/03/19.
...
class EmployeeSettingsSetupWorkingHours:UIViewController, UITableViewDelegate, UITableViewDataSource,isOpenRowDelegate4 {
    ...
    override func viewDidLoad() {
        ...
        TitleScreen.text = "ADD_EMPLOYEE_HOURS".localized(LanguageMain.sharedInstance.USERLANGUAGE)
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell:EmployeeSettingsEditWorkingHoursCell = tableView.dequeueReusableCell(withIdentifier: "EmployeeSettingsEditWorkingHoursCell") as! EmployeeSettingsEditWorkingHoursCell
