...
//  bthree-ios
//
//  Created by Ioan Ungureanu 20/02/2018 this is clean and closed
...
class HoursBusinessTableViewCell: UITableViewCell {
...
//                rectangleCheckdaybtnarray[i].userInteractionEnabled = false
            ...
            Global.sharedInstance.arrWorkHours = arrWorkHours
            btnSelectAllDays.setImage(UIImage(named: "9.png"), for: UIControl.State())
            DELEGATERELOAD.reloadWorkingandBreaksLabels()//reloadTbl()
...
//                if   Global.sharedInstance.isHoursSelected[neededtag] == false {
            ...
            for daybtn in daybtnarray {
                if daybtn.backgroundColor == Colors.sharedInstance.darkred { //we know was in edit mode and now we need to close
                    ...
                    if (completedHOURS.nvFromHour != completedHOURS.nvToHour  && completedHOURS.nvFromHour != "" &&  completedHOURS.nvToHour != "" ) {
                        ...
                        Global.sharedInstance.isHoursSelected[neededtag] = true
   ...
   @objc func selectAllTap()
    ...
    @objc func handleDatePicker(_ sender: UIDatePicker)
    {
        ...
        if (Global.sharedInstance.defaults.integer(forKey: "CHOOSEN_LANGUAGE") == 0) {
            let nvFromHour = outputFormatter.string(from: dtToHour.date)
            let nvToHour = outputFormatter.string(from: dtFromHour.date)
            switch (sender) {
    ...
    override func layoutSubviews(){
        ...
        dtFromHour.setDate ( dateFormatter.date(from: "08:00:00")!, animated:  true )
        dtToHour.setDate ( dateFormatter.date(from: "20:00:00")!, animated:  true )
