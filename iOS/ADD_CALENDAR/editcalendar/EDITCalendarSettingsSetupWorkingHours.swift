//
//  EDITCalendarSettingsSetupWorkingHours.swift
//  Bthere
//
...
//}
class EDITCalendarSettingsSetupWorkingHours:UIViewController, UITableViewDelegate, UITableViewDataSource,isOpenRowDelegate6 {
    ...
    override func viewDidLoad() {
        ...
        TitleScreen.text = "EDIT_CALENDARS_HOURS".localized(LanguageMain.sharedInstance.USERLANGUAGE)
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell:EDITCalendarSettingsEditWorkingHoursCell = tableView.dequeueReusableCell(withIdentifier: "EDITCalendarSettingsEditWorkingHoursCell") as! EDITCalendarSettingsEditWorkingHoursCell
