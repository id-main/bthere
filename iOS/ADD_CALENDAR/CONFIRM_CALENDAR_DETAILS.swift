//
//  CONFIRM_CALENDAR_DETAILS.swift
//  Bthere
//
...
class CONFIRM_CALENDAR_DETAILS: UIViewController, UIGestureRecognizerDelegate {
    var delegate:SettingsSetupCalendars!=nil
    var delegate1:SettingsSetupCalendars!=nil
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        titletext.text = "CONFIRM_CALENDARS_DETAILS".localized(LanguageMain.sharedInstance.USERLANGUAGE)
        ...
        ACCESS_PERMISSIONS.isEnabled = false
...
//            window.rootViewController = mainRevealController
       // self.dismiss(animated: true, completion: nil)
        if isNEW == true  {
        Global.sharedInstance.ARRAYCALENDAR.append(Global.sharedInstance.NEW_EMPLOYEE_EDIT)
        delegate.reloadTableFull()
        delegate.AddEmployeaddtoArray(_whichID: Global.sharedInstance.NEW_EMPLOYEE_EDIT.objsers.iUserId)
        } else {
        Global.sharedInstance.ARRAYCALENDAR[myIndex] = Global.sharedInstance.NEW_EMPLOYEE_EDIT
