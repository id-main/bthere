//
//  SettingsNewBussinesServicesTableViewCell.swift
...
class SettingsNewBussinesServicesTableViewCell: UITableViewCell,UITableViewDataSource,UITableViewDelegate,UITextFieldDelegate,saveDataToWorkerDelegate,TTTAttributedLabelDelegate{
...
//        lblNumCustomers.adjustsFontSizeToFitWidth = true
//        lblRangTime.adjustsFontSizeToFitWidth = true
        if  Global.sharedInstance.defaults.integer(forKey: "CHOOSEN_LANGUAGE") == 3
        {
            lblServiceName.numberOfLines = 0
            lblNumCustomers.numberOfLines = 0
            lblRangTime.numberOfLines = 0
        }

//        txtServiceName.adjustsFontSizeToFitWidth = true
    }
    ...
    func setDisplayData(_ service:objProviderServices){
     //   lblServiceProduct.sizeToFit()
        ...
        iProviderServiceId = service.iProviderServiceId
...
//                    {
//                        if let valInt:Int = txtServiceName.text?.count
//                        {
//                            if ((valInt - 10) > 0)
//                            {
//                                let name: String = txtServiceName.text!
//                                let endIndex = name.index(name.endIndex, offsetBy: -(valInt - 10) )
//                                let truncated = name.substring(to: endIndex)
//                                txtServiceName.text! = truncated
//                            }
//                        }
...
//                            {
//                                let name: String = txtServiceName.text!
//                                let endIndex = name.index(name.endIndex, offsetBy: -(valInt - 22) )
//                                let truncated = name.substring(to: endIndex)
//                                txtServiceName.text! = truncated
//                            }
//                        }
//                        showAlert("ENTER_ONLY22_CHARACTERS".localized(LanguageMain.sharedInstance.USERLANGUAGE))
//                    }
//                    else
//                    {
//                        if let valInt:Int = txtServiceName.text?.count
        ...
        //    delegateSave.reloadTableForSave(self.tag,btnTag:3)
            ...
            if (   Global.sharedInstance.isValidPrice == true &&  Global.sharedInstance.isValidServiceName == true &&  Global.sharedInstance.isValidTimeInterval == true &&  Global.sharedInstance.isValidTimeOfService == true &&  Global.sharedInstance.isValidMaxConcurrent == true )
            {
                ...
                objProviderServicess = objProviderServices(
                    ...
                    _iProviderServiceId: self.iProviderServiceId,
                ...
                if Global.sharedInstance.generalDetails.arrObjProviderServices.count == 0 || txtPrice.tag == -11
                {
                    ...
                    if ok == true {
                        if iProviderServiceId == 0 {
                             let isIndexValid = Global.sharedInstance.generalDetails.arrObjProviderServices.indices.contains(self.tag)
                             if isIndexValid == true {
                            Global.sharedInstance.generalDetails.arrObjProviderServices.remove(at: self.tag) //those are with id!=0 so  need to add id
                            Global.sharedInstance.generalDetails.arrObjProviderServices.insert(objProviderServicess, at: self.tag)
                             } else {
                            Global.sharedInstance.generalDetails.arrObjProviderServices.append(objProviderServicess) //those are with 0 so no need to add id
                            }
                      //
                        }
                    ...
                    if ok == true {
                         let isIndexValid = Global.sharedInstance.generalDetails.arrObjProviderServices.indices.contains(txtPrice.tag)
                        if iProviderServiceId != 0 {
                        let ax = Global.sharedInstance.generalDetails.arrObjProviderServices[txtPrice.tag].iProviderServiceId
                        self.delegate.UpdateServiceaddtoArray(_whichID: ax)
                            if isIndexValid == true {
                        Global.sharedInstance.generalDetails.arrObjProviderServices.remove(at: txtPrice.tag) //those are with id!=0 so  need to add id
