...
class BussinesServicesTableViewCell: UITableViewCell,UITableViewDataSource,UITableViewDelegate,UITextFieldDelegate,delKbNotifBusinessDelegate,saveDataToWorkerDelegate,TTTAttributedLabelDelegate{
...
//    var serviceNameCopy:String = ""
    ...
    @IBOutlet weak var dyanmiclabelDiscount: NSLayoutConstraint! //label discount for series
    @IBOutlet weak var dyanmictextDiscount: NSLayoutConstraint! //for txt discount
    ...
    {
//        print("btn save: \(Thread.callStackSymbols.forEach{print($0)})")
        
//        if serviceNameCopy == ""
//        {
//            if let _ = txtServiceName.text
//            {
//                serviceNameCopy = txtServiceName.text!
//            }
//
//        }
...
//                //txtDiscount.text = "REQUIREFIELD".localized(LanguageMain.sharedInstance.USERLANGUAGE)
...
////        serviceNameCopy = ""
    ...
    override func awakeFromNib()
    {
        ...
        if UIDevice.current.userInterfaceIdiom == .pad {
            ...
            self.dyanmiclabelDiscount.constant = 70
            self.dyanmictextDiscount.constant = 50
        } else {
            if DeviceType.IS_IPHONE_5 || DeviceType.IS_IPHONE_4_OR_LESS
            {
                ...
                self.dyanmiclabelDiscount.constant = 80
                self.dyanmictextDiscount.constant = 40
            }
            else
            {
    ...
    func setDisplayData(_ service:objProviderServices){
        ...
        initaldiscount = txtDiscount.text!
    }
...
//        }
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {var str:String = ""
        ...
        case tblSelectOption:
            ...
            if lblInputServiceName.text == "PRODUCT".localized(LanguageMain.sharedInstance.USERLANGUAGE)
            {
                ...
                lblSale.text = "DISCOUNT_ORDRER_MORE_PRODUCTS".localized(LanguageMain.sharedInstance.USERLANGUAGE)
                lblServiceName.text = "PRODUCT_NAME".localized(LanguageMain.sharedInstance.USERLANGUAGE)
    ...
    func textFieldDidBeginEditing(_ textField: UITextField) {
        ...
        if textField == txtDiscount
        {
            ...
            {
                Global.sharedInstance.fDiscount = false
                txtDiscount.text =  txtDiscount.text!.substring(to: txtDiscount.text!.index(before: txtDiscount.text!.endIndex))
            }
        }
...
//            for service:objProviderServices in Global.sharedInstance.generalDetails.arrObjProviderServices
//            {
//                if txtServiceName.text == service.nvServiceName
//                {
//
//                    txtServiceName.textColor = .red
//                    txtServiceName.text = "ALREADY_USED_SERVICE_NAME".localized(LanguageMain.sharedInstance.USERLANGUAGE)
//                    Global.sharedInstance.isValidServiceName = false
//                }
//            }
   ...
   @objc func keyboardWillHide(_ note: Notification)
    ...
    {
//        print("save data to worker: \(Thread.callStackSymbols.forEach{print($0)})")
//
//        if serviceNameCopy == ""
//        {
//            if let _ = txtServiceName.text
        ...
        if lblInputServiceName.text == "SERVICE".localized(LanguageMain.sharedInstance.USERLANGUAGE) {
            ...
            if ( Global.sharedInstance.isValidDiscount == true  &&  Global.sharedInstance.isValidPrice == true &&  Global.sharedInstance.isValidServiceName == true &&  Global.sharedInstance.isValidTimeInterval == true &&  Global.sharedInstance.isValidTimeOfService == true &&  Global.sharedInstance.isValidMaxConcurrent == true )
            {
              ...
              //\\  print(txtServiceName.text)
                ...
                finaldiscount = txtDiscount.text!
                ...
                if Global.sharedInstance.generalDetails.arrObjProviderServices.count == 0 || txtPrice.tag == -11
                {
                    ...
                    for i in Global.sharedInstance.generalDetails.arrObjProviderServices {
                        ...
                        if (objProviderServicess.nvServiceName == i.nvServiceName &&
                            ...
                            objProviderServicess.iDiscount  == i.iDiscount
                            )  {
                            ok = false
