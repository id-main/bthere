//
//  JoEditWorkerViewController.swift
//  Bthere
//
...
protocol reloadTblDelegateParentWorkers {
    func reloadTbl()
...
class JoEditWorkerViewController: NavigationModelViewController, UIGestureRecognizerDelegate, UITextViewDelegate, UITableViewDelegate, UITableViewDataSource, UITextFieldDelegate, UIScrollViewDelegate, reloadTblDelegateParentWorkers {
    ...
    override func viewDidLoad() {
        ...
        heightforrowsarray = [0,0,0]
        drawelements()
        print(Global.sharedInstance.generalDetails.arrObjServiceProviders[INDEXPATHFROMARRAYOTEDIT].getDic())
        let user = Global.sharedInstance.generalDetails.arrObjServiceProviders[INDEXPATHFROMARRAYOTEDIT].objsers
        Global.sharedInstance.arrWorkHoursChild = Global.sharedInstance.arrObjServiceProvidersForEdit[INDEXPATHFROMARRAYOTEDIT].arrObjWorkingHours
        Global.sharedInstance.isSelectAllHoursChild = Global.sharedInstance.arrObjServiceProvidersForEdit[INDEXPATHFROMARRAYOTEDIT].isSelectAllHours
        Global.sharedInstance.isHoursSelectedChild = Global.sharedInstance.arrObjServiceProvidersForEdit[INDEXPATHFROMARRAYOTEDIT].isHoursSelected
        Global.sharedInstance.arrWorkHoursRestChild = Global.sharedInstance.arrObjServiceProvidersForEdit[INDEXPATHFROMARRAYOTEDIT].arrObjWorkingRest
        Global.sharedInstance.isSelectAllRestChild = Global.sharedInstance.arrObjServiceProvidersForEdit[INDEXPATHFROMARRAYOTEDIT].isSelectAllRecess
        Global.sharedInstance.isHoursSelectedRestChild = Global.sharedInstance.arrObjServiceProvidersForEdit[INDEXPATHFROMARRAYOTEDIT].isHoursSelectedRest
    ...
    func drawelements(){
        ...
        let bsameh = Global.sharedInstance.generalDetails.arrObjServiceProviders[INDEXPATHFROMARRAYOTEDIT].bSameWH
...
//                Alert.sharedInstance.showAlertDelegate("NO_INTERNET".localized(LanguageMain.sharedInstance.USERLANGUAGE))
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell1:HoursExistingWorkerTableViewCell = tableView.dequeueReusableCell(withIdentifier: "HoursExistingWorkerTableViewCell")as!HoursExistingWorkerTableViewCell
        let cell2:BreaksExistingWorkerTableViewCell = tableView.dequeueReusableCell(withIdentifier: "BreaksExistingWorkerTableViewCell")as!BreaksExistingWorkerTableViewCell
