//  HoursWorkerTableViewCell.swift
//  bthree-ios
//
//  Created by Ioan Ungureanu 30/03/2018 this is clean and closed
...
class HoursWorkerTableViewCell: UITableViewCell {
    var generic = Generic()
    ...
    var DELEGATERELOAD:reloadTblDelegateParentWorker!=nil
    ...
    @IBOutlet weak var ADDRECCESSVIEW: UIView!
    //FUNCTIONS
    func hidetoast(){
    ...
    @objc func OPENBREAKS() {
        ...
        if CANOPENBREAKS == true {
    DELEGATERELOAD.OPENBREAKS()
        } else {
    DELEGATERELOAD.showerroemessageforaddbreaks()
        }
    }
//    DELEGATERELOAD.OPENHOURS()
    @IBAction func btnSelectAllDays(_ sender: AnyObject)
    {
        ...
        if btnSelectAllDays.currentImage == (UIImage(named: "15a.png")) {
            ...
            for i in 0...6 {
                ...
                DayFlagArr[i] = 0
                arrWorkHours[i] = objWorkingHours()
                ...
                workingHoursTEST.iDayInWeekType = i
                Global.sharedInstance.arrWorkHoursRestChild[i] = workingHoursTEST
//                rectangleCheckdaybtnarray[i].isChecked = false
//                rectangleCheckdaybtnarray[i].userInteractionEnabled = false
            }
            Global.sharedInstance.arrWorkHoursChild = arrWorkHours
...
//                if   Global.sharedInstance.isHoursSelectedChild[neededtag] == false {
//                    daybtnarray[neededtag].backgroundColor = UIColor.darkGrayColor()
//                    DayFlagArr[neededtag] = 0
//                    let workingHoursTEST:objWorkingHours = objWorkingHours()
//                    workingHoursTEST.iDayInWeekType = neededtag
//                    arrWorkHours[neededtag] = workingHoursTEST
//                    Global.sharedInstance.isHoursSelectedChild[neededtag] = false
//                    Global.sharedInstance.arrWorkHoursChild = arrWorkHours
//                    Global.sharedInstance.isHoursSelectedRestChild[neededtag] = false
//                    Global.sharedInstance.arrWorkHoursRestChild[neededtag] = workingHoursTEST
//                    DELEGATERELOAD.reloadTbl()
//                } else {
//                    
//                }
            for daybtn in daybtnarray {
                if daybtn.backgroundColor == Colors.sharedInstance.darkred { //we know was in edit mode and now we need to close
                    ...
                    let completedHOURS = arrWorkHours[neededtag]
                    if (completedHOURS.nvFromHour != completedHOURS.nvToHour  && completedHOURS.nvFromHour != "" &&  completedHOURS.nvToHour != "" ) {
                        ...
                        DayFlagArr[neededtag] = 0
                        arrWorkHours[neededtag] = completedHOURS
                        Global.sharedInstance.isHoursSelectedChild[neededtag] = true
                        rectangleCheckdaybtnarray[neededtag].isChecked = true
                        //also clean breaks because of possible modification of hours
                        Global.sharedInstance.isHoursSelectedRestChild[neededtag] = false
                        let workingHoursTEST:objWorkingHours = objWorkingHours()
                        workingHoursTEST.iDayInWeekType = neededtag
                        Global.sharedInstance.arrWorkHoursRestChild[neededtag] = workingHoursTEST
                        ...
                        DayFlagArr[neededtag] = 0
                        arrWorkHours[neededtag] = objWorkingHours()
                        Global.sharedInstance.isHoursSelectedChild[neededtag] = false
             ...
             DELEGATERELOAD.reloadTbl()
                ...
                /* will think to something smarter in a good day ... else {
                   
                     daybtnarray[neededtag].selected = !daybtnarray[neededtag].selected
                     btnSelectDay(daybtnarray[neededtag])
                }
 */
          //  }
        } else {
    ...
    @IBAction func btnSelectDay(_ sender:AnyObject) {
        ...
        if daybtnarray[neededtag!].isSelected == true {
            ...
            if (completedHOURS.nvFromHour != completedHOURS.nvToHour  && completedHOURS.nvFromHour != "" &&  completedHOURS.nvToHour != "" ) {
                ...
                daybtnarray[neededtag!].backgroundColor = Colors.sharedInstance.darkred //Colors.sharedInstance.color4
...
//                        rectangleCheckdaybtnarray[neededtag].userInteractionEnabled = false
            ...
            for item in daybtnarray {
                if item.backgroundColor == Colors.sharedInstance.color4 ||  item.backgroundColor == Colors.sharedInstance.darkred  {
                    btnselect = true
                    break
                }
            }
    ...
    @objc func selectAllTap()
    {
        ...
        for item in daybtnarray {
            item.backgroundColor = Colors.sharedInstance.color4
        ...
        for i in 0...6 {
            workingHoursTEST = objWorkingHours(
                ...
                _nvToHour: prefectTo)
            arrWorkHours[i] = workingHoursTEST
    ...
    @objc func handleDatePicker(_ sender: UIDatePicker)
    {
            ...
            if (dtToHour.date > dtFromHour.date   ) {
                for item in  daybtnarray {
                    ...
                    if item.backgroundColor == Colors.sharedInstance.darkred  {
                        ...
                        workingHoursTEST = objWorkingHours(
                            ...
                            _nvToHour: nvToHour)
                        arrWorkHours[myindex!] = workingHoursTEST
                    }
                }
                ...
                for item in  daybtnarray {
                    ...
                    if item.backgroundColor == Colors.sharedInstance.darkred {
                        ...
                        arrWorkHours[myindex!] = objWorkingHours()
                    }
                }
            }
        ...
        case dtToHour:
            if (dtToHour.date > dtFromHour.date ) {
                for item in  daybtnarray {
                    let myindex = daybtnarray.index(of: item)
                    //all  items opened to edit and not having blue or black
                    if item.backgroundColor == Colors.sharedInstance.darkred {
                        var workingHoursTEST:objWorkingHours = objWorkingHours()
                        workingHoursTEST = objWorkingHours(
                            _iDayInWeekType: myindex!,
    ...
    override func awakeFromNib() {
        ...
        self.MAINVIEW.layer.borderColor = Colors.sharedInstance.color4.cgColor
        ...
        let tap1:UITapGestureRecognizer = UITapGestureRecognizer(target: self, action: #selector(OPENBREAKS))
        tap1.delegate = self
        ADDRECCESSVIEW.addGestureRecognizer(tap1)
        self.contentView.bringSubviewToFront(ADDRECCESSVIEW)
    ...
    override func layoutSubviews(){
        ...
        for i in 0 ..< 7
        {
            ...
            {
                ycount += 1
                daybtnarray[i].backgroundColor = Colors.sharedInstance.color4
    ...
    func changeRectangleColorandBorder() {
        MAINVIEW.layer.borderColor = Colors.sharedInstance.color4.cgColor
